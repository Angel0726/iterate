...
distutils.core.setup(arguments)
   ...
   | *name*               | 包的名字                         | 字符串                                                        |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *version*            | The version number of the        | 字符串                                                        |
   |                      | package; see "distutils.version" |                                                               |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *description*        | 单行的包的描述                   | 字符串                                                        |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *long_description*   | 更长的包的描述                   | 字符串                                                        |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *author*             | 包的作者                         | 字符串                                                        |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   ...
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *py_modules*         | A list of Python modules that    | 字符串列表                                                    |
   |                      | distutils will manipulate        |                                                               |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *scripts*            | A list of standalone script      | 字符串列表                                                    |
   ...
   |                      | package                          |                                                               |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *distclass*          | the "Distribution" class to use  | "distutils.core.Distribution" 的子类                          |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *script_name*        | The name of the setup.py script  | 字符串                                                        |
   |                      | - defaults to "sys.argv[0]"      |                                                               |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *script_args*        | 提供给安装脚本的参数             | 字符串列表                                                    |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *options*            | 安装脚本的默认选项               | a dictionary                                                  |
   +----------------------+----------------------------------+---------------------------------------------------------------+
   | *license*            | 包的许可证                       | 字符串                                                        |
   +----------------------+----------------------------------+---------------------------------------------------------------+
...
class distutils.core.Extension
   ...
   +--------------------------+----------------------------------+-----------------------------+
   | *undef_macros*           | list of macros to undefine       | 字符串列表                  |
   |                          | explicitly                       |                             |
   +--------------------------+----------------------------------+-----------------------------+
   | *library_dirs*           | list of directories to search    | 字符串列表                  |
   |                          | for C/C++ libraries at link time |                             |
   +--------------------------+----------------------------------+-----------------------------+
   | *libraries*              | list of library names (not       | 字符串列表                  |
   ...
   |                          | "init" + extension_name.         |                             |
   +--------------------------+----------------------------------+-----------------------------+
   | *depends*                | list of files that the extension | 字符串列表                  |
   |                          | depends on                       |                             |
   +--------------------------+----------------------------------+-----------------------------+
...
distutils.file_util.move_file(src, dst[, verbose, dry_run])
   ...
   警告: Handles cross-device moves on Unix using "copy_file()".
...
* boolean options can have "negative aliases" --- eg. if "--quiet"
  is the "negative alias" of "--verbose", then "--quiet" on the
