...
注解: 推荐使用如上 C99 风格的初始化，以避免列出所有的 "PyTypeObject"
...
注解: If you are creating a co-operative "tp_new" (one that calls a
...
注解: The "tp_traverse" implementation must name its arguments
