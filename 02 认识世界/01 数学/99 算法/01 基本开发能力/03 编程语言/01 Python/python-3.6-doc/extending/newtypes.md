...
注解: There are limitations to what you can safely do in a
...
如果 "tp_methods" 非 *NULL*，它必须引用一个 "PyMethodDef" 结构的数组。
表中的每个条目都是这个结构的一个实例:
...
1. Include a "PyObject*" field in the C object structure dedicated
