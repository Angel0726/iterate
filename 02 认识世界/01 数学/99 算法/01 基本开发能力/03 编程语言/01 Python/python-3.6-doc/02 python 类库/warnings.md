...
defined in this module.  (C programmers use "PyErr_WarnEx()"; see 异常
处理 for details).
...
参见: "logging.captureWarnings()" allows you to handle all warnings
...
在 3.2 版更改: "DeprecationWarning" is now ignored by default in
...
class warnings.catch_warnings(*, record=False, module=None)
   ...
   注解: The "catch_warnings" manager works by replacing and then
